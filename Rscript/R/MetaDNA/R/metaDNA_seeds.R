#Region "Microsoft.ROpen::4dc167fe3e9c0f06603d0fd3678afe88, metaDNA_seeds.R"

    # Summaries:

    # seeding <- function(output, rt.adjust, seeds.all) {...
    # seeding_impl <- function(seeds, seedsCluster, rt.adjust, seeds.all) {for (feature in seedsCluster) {...
