#Region "Microsoft.ROpen::6cd3d83335fa940a53709746a8608dbf, metaDNA.R"

    # Summaries:

    # metaDNA <- function(identify, unknown, do.align,precursor_type= c("[M+H]+", "[M]+"),tolerance     = assert.deltaMass(0.3),rt.adjust     = function(rt, KEGG_id) 1,score.cutoff  = 0.8,kegg_id.skips = NULL,seeds.all     = TRUE,seeds.topn    = 5,iterations    = 20, network.class_links = NULL,libtype = 1) {...
