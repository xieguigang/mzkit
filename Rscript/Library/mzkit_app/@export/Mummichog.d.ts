...
declare namespace Mummichog {
   ...
   */
   ...
   /**
     * @param alternative default value Is ``false``.
   */
   function kegg_background(maps: object, reactions: object, alternative?: boolean): object;
   /**
     * @param minHits default value Is ``-1``.
     * @param ignore_topology default value Is ``false``.
   */
   function mzScore(result: object, minHits?: object, ignore_topology?: boolean): object;
   /**
     * @param minhit default value Is ``3``.
     * @param permutation default value Is ``100``.
     * @param modelSize default value Is ``-1``.
     * @param pinned default value Is ``null``.
     * @param ignore_topology default value Is ``false``.
     * @param ga default value Is ``false``.
     * @param pop_size default value Is ``100``.
     * @param mutation_rate default value Is ``0.3``.
     * @param env default value Is ``null``.
   */
