...
//
//    imports "RamanSpectroscopy" from "mzkit";
//
// ref=mzkit.RamanSpectroscopy@mzkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null
 ...
 * 
*/
declare namespace RamanSpectroscopy {
   /**
    * parse the Raman Spectroscopy data from a text file
    * 
    * 
     * @param file A file path of a ascii text file that contains the Raman Spectroscopy data
     * @param env -
     * 
     * + default value Is ``null``.
   */
   function readFile(file: any, env?: object): object;
}
