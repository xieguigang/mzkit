...
<!-- vscode-markdown-toc -->
* 1. [--==== TOC ====--](#TOC--)
* 2. [Raw Data Viewer Instruction](#RawDataViewerInstruction)
	* 2.1. [Imports raw data file](#Importsrawdatafile)
	* 2.2. [Search Feature](#SearchFeature)
	* 2.3. [XIC plot](#XICplot)

		* 2.3.1. [XIC overlay](#XICoverlay)

	* 2.4. [TIC plot](#TICplot)
	* 2.5. [View Mass spectra](#ViewMassspectra)
	* 2.6. [Save Plot and Export matrix](#SavePlotandExportmatrix)

		* 2.6.1. [Export XIC](#ExportXIC)
        
* 3. [Data Annotations](#DataAnnotations)
	* 3.1. [Formula search](#Formulasearch)
	* 3.2. [Export Formula Search Result](#ExportFormulaSearchResult)
* 4. [Credits](#Credits)
...
##  2. <a name='RawDataViewerInstruction'></a>Raw Data Viewer Instruction

###  2.1. <a name='Importsrawdatafile'></a>Imports raw data file
...
###  2.2. <a name='SearchFeature'></a>Search Feature
...
####  2.3.1. <a name='XICoverlay'></a>XIC overlay
...
###  2.5. <a name='ViewMassspectra'></a>View Mass spectra
...
###  2.6. <a name='SavePlotandExportmatrix'></a>Save Plot and Export matrix
...
####  2.6.1. <a name='ExportXIC'></a>Export XIC
...
##  3. <a name='DataAnnotations'></a>Data Annotations

###  3.1. <a name='Formulasearch'></a>Formula search
...
###  3.2. <a name='ExportFormulaSearchResult'></a>Export Formula Search Result
