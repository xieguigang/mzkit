...
Namespace MetaLib
    ...
    Public Module KEGGExtensions
        ...
        ''' </param>
        ''' <param name="KEGGcpd">
        ''' KEGG的代谢物数据库的文件夹路径，在这个文件夹里面应该包含有Glyan物质的数据
        ''' </param>
        ''' <returns></returns>
        Public Function KEGGDrugGlyan2Compound(keggDrug$, KEGGcpd$) As Dictionary(Of String, String)
            Dim drugs = DrugParser.ParseStream(keggDrug).ToArray
