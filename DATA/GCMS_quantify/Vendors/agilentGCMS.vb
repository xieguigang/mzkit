...
Public Module agilentGCMS
    ...
    Public Function Read(cdf As netCDFReader) As GCMSJson
        Dim time = cdf.getDataVariable("scan_acquisition_time")
        Dim tic = cdf.getDataVariable("total_intensity")
        Dim pointCount = cdf.getDataVariable("point_count")
        Dim massValues = cdf.getDataVariable("mass_values").numerics
        Dim intensityValues = cdf.getDataVariable("intensity_values").numerics

        Dim ms As ms1_scan()() = New ms1_scan(pointCount.Length)() {}
