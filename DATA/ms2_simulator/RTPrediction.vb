...
''' moleculate strucutre composition linear regression model.
''' </summary>
Public Module RTPrediction
    ...
    <Extension>
    Public Function KCFComposition(KCF As KCF) As Dictionary(Of String, Integer)
    ...
    ''' <returns>
    ''' Using this linear regression fitted model for predicted of the unknowns
    ''' </returns>
