#Region "Microsoft.ROpen::1592f10dfe88bc7ca5e30ad8c77e55e9, metaDNA.R"

    # Summaries:

    # metaDNA <- function(identify, unknown, do.align,precursor_type = c("[M+H]+", "[M]+"),tolerance = assert.deltaMass(0.3),score.cutoff = 0.8,kegg_id.skips = NULL,seeds.all = TRUE,iterations = 20) {...
