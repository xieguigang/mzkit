#Region "Microsoft.ROpen::60253895cd11588dd5928566132b37d7, PrecursorType.R"
    ...
    # PrecursorType.Match <- function(mass, precursorMZ, charge,chargeMode= "+",minError.ppm = 100,debug.echo= TRUE) {if (charge == 0) {...
    # .PrecursorType.MatchImpl <- function(mass, precursorMZ, charge,chargeMode, minError.ppm,debug.echo) {...
