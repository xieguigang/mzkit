...
Namespace Chromatogram.PeakFinding
    ...
    Public Class PeakDetector
        ...
        ''' </summary>
        Public Shared Function EstimateFWHM(ticks As ChromatogramTick(),
        ...
        ''' </summary>
        Public Shared Function EstimateAsymmetryFactor(ticks As ChromatogramTick(),
        ...
        ''' </summary>
        Public Shared Function MergeClosePeaks(peaks As List(Of ROI), mergeDistance As Double) As List(Of ROI)
