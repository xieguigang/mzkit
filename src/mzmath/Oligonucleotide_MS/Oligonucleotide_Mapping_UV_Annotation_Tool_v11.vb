...
'Sort the worksheet based on retention time (which is usually the default)
    ...
    ActiveWorkbook.Worksheets(2).Sort.SortFields.Add2 Key:= _
...
'22 Label | 23 % TIC Base Peak | 24 1st Sample Mass | 25 1st Sample Area | 26 2nd Sample Mass ...
    ...
    ThisWorkbook.Worksheets(10).Sort.SortFields.Add Key:=Range(Cells(1, Nsamples + 10), Cells(lng1 + 1, Nsamples + 10)), _
...
'Sort Table2 by RT and intensity-----------------------------------------------------------------------
    ...
    ThisWorkbook.Worksheets(5).Sort.SortFields.Add Key:=Range(Cells(1, 7), Cells(lng1, 7)), _
        SortOn:=xlSortOnValues, Order:=xlAscending, DataOption:=xlSortNormal
