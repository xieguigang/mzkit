    ...
    New SpectrumPeak(adduct.ConvertToMz(Gly_O), 200R, "Gly-O") With {
        .SpectrumComment = SpectrumComment.metaboliteclass
            ...
            If Equals(adduct.AdductIonName, "[M+H]+") Then
                spectrum.AddRange({New SpectrumPeak(adduct.ConvertToMz(C3H9O6P), 100R, "[C3H9O6P+H]+") With {
.SpectrumComment = SpectrumComment.metaboliteclass
}, New SpectrumPeak(adduct.ConvertToMz(C3H9O6P - H2O), 100R, "[C3H9O6P+H]+ -H2O") With {
.SpectrumComment = SpectrumComment.metaboliteclass
