...
.SpectrumComment = SpectrumComment.acylchain
        ...
        Private Function GetAcylPositionSpectrum(ByVal lipid As ILipid, ByVal acylChain As IChain, ByVal adduct As AdductIon) As SpectrumPeak()
            ...
            Return {New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - chainMass - HydrogenMass - OxygenMass - CD2), 100R, "-CD2(Sn1)") With {
.SpectrumComment = SpectrumComment.snposition
}, New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - chainMass - HydrogenMass - OxygenMass - H2O - CD2), 100R, "-H2O -CD2(Sn1)") With {
.SpectrumComment = SpectrumComment.snposition
}}
        End Function
