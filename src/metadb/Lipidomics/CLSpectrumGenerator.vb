...
.SpectrumComment = SpectrumComment.metaboliteclass
        ...
        Private Function GetAcylLevelSpectrum(ByVal lipid As ILipid, ByVal acylChains As IEnumerable(Of IChain), ByVal adduct As AdductIon, ByVal nlMass As Double) As IEnumerable(Of SpectrumPeak)
            ...
            Dim spectrum = New List(Of SpectrumPeak) From {
    New SpectrumPeak(lipidMass - sn1sn2mass + ProtonMass, 80R, $"[M-Sn1-Sn2-C3H3O2+H]+") With {
        .SpectrumComment = SpectrumComment.acylchain
    },
    New SpectrumPeak(lipidMass - sn3sn4mass + ProtonMass, 80R, $"[M-Sn3-Sn4-C3H3O2+H]+") With {
        .SpectrumComment = SpectrumComment.acylchain
    },
    New SpectrumPeak(lipidMass - sn1sn2mass + ProtonMass - H2O, 80R, $"[M-Sn1-Sn2-C3H3O2-H2O+H]+") With {
        .SpectrumComment = SpectrumComment.acylchain
    },
    New SpectrumPeak(lipidMass - sn3sn4mass + ProtonMass - H2O, 80R, $"[M-Sn3-Sn4-C3H3O2-H2O+H]+") With {
        .SpectrumComment = SpectrumComment.acylchain
    },
    New SpectrumPeak(sn1sn2mass + ProtonMass, 300R, $"[Sn1+Sn2+C3H3O2+H]+") With {
        .SpectrumComment = SpectrumComment.acylchain
    },
    New SpectrumPeak(sn3sn4mass + ProtonMass, 300R, $"[Sn3+Sn4+C3H3O2+H]+") With {
        .SpectrumComment = SpectrumComment.acylchain
    }
        ...
        Private Function GetAcylLevelSpectrum(ByVal lipid As ILipid, ByVal acylChain As IChain, ByVal adduct As AdductIon, ByVal nlMass As Double) As SpectrumPeak()
            Dim lipidMass = lipid.Mass
    ...
    New SpectrumPeak(chainMass + C3H6O2 + ProtonMass, 50R, $"{acylChain} +C3H6O2") With {
        .SpectrumComment = SpectrumComment.acylchain
    },
    New SpectrumPeak(chainMass + C3H6O2 - OxygenMass + ProtonMass, 50R, $"{acylChain} +C3H6O") With {
        .SpectrumComment = SpectrumComment.acylchain
    },
    New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - chainMass - nlMass), 50R, $"-{acylChain}") With {
        .SpectrumComment = SpectrumComment.acylchain
    }
}
        ...
        Private Function GetAcylPositionSpectrum(ByVal lipid As ILipid, ByVal acylChain As IChain, ByVal adduct As AdductIon, ByVal nlMass As Double) As SpectrumPeak()
            ...
            Dim chainMass = acylChain.Mass - HydrogenMass
            Dim spectrum = New List(Of SpectrumPeak) From {
    New SpectrumPeak(lipidMass - nlMass - chainMass - CH2, 20R, "-CH2(Sn1)") With {
