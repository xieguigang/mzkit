Friend NotInheritable Class ChainsDecomposer
    ...
    Private Function Decompose2(Of T)(visitor As IAcyclicVisitor, element As T) As ITotalChain Implements IDecomposer(Of ITotalChain, MolecularSpeciesLevelChains).Decompose
    ...
    Private Function Decompose3(Of T)(visitor As IAcyclicVisitor, element As T) As ITotalChain Implements IDecomposer(Of ITotalChain, PositionLevelChains).Decompose
        Dim chains = element.GetDeterminedChains().[Select](Function(c) c.Accept(visitor, IdentityDecomposer(Of IChain, IChain).Instance)).ToArray()
