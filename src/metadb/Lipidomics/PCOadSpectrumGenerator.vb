...
Namespace CompMs.Common.Lipidomics
    Public Class PCOadSpectrumGenerator
        ...
        Public Function Generate(ByVal lipid As Lipid, ByVal adduct As AdductIon, ByVal Optional molecule As IMoleculeProperty = Nothing) As IMSScanProperty Implements ILipidSpectrumGenerator.Generate
            ...
            '"OAD17",
            '"OAD01+H" 
            Dim oadId = If(adduct.IonMode = IonMode.Positive, New String() {"OAD01", "OAD02", "OAD02+O", "OAD03", "OAD04", "OAD08", "OAD12", "OAD14", "OAD15", "OAD15+O", "OAD16", "OAD17", "OAD12+O", "OAD12+O+H", "OAD12+O+2H", "OAD01+H"}, New String() {"OAD01", "OAD02", "OAD03", "OAD04", "OAD05", "OAD10", "OAD13", "OAD15", "OAD16", "OAD12+O", "OAD12+O+H", "OAD12+O+2H"})
...
}, New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - chain.Mass + HydrogenMass - H2O), 15R, $"-{chain}-H2O") With {
.SpectrumComment = SpectrumComment.acylchain
}, New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - chain.Mass + HydrogenMass * 2), 10R, $"-{chain}+H") With {
.SpectrumComment = SpectrumComment.acylchain
}, New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - chain.Mass + HydrogenMass * 2 - H2O), 10R, $"-{chain}-H2O +H") With {
.SpectrumComment = SpectrumComment.acylchain
}})
                    Next
                End If
...
.SpectrumComment = SpectrumComment.precursor
}, New SpectrumPeak(lipid.Mass - CH3, 100R, "[M-CH3]-") With {
.SpectrumComment = SpectrumComment.metaboliteclass
}})
...
.SpectrumComment = SpectrumComment.acylchain
}, New SpectrumPeak(chain.Mass + OxygenMass + Electron + HydrogenMass, 10R, $"{chain} FA +H") With {
.SpectrumComment = SpectrumComment.acylchain
}})
                    Next
                End If
