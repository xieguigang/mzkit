...
.SpectrumComment = SpectrumComment.acylchain
        ...
        Private Function GetAcylPositionSpectrum(ByVal lipid As ILipid, ByVal acylChain As IChain, ByVal adduct As AdductIon) As SpectrumPeak()
            Dim chainMass = acylChain.Mass - HydrogenMass
            Dim spectrum = New List(Of SpectrumPeak) From {
    New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - chainMass - HydrogenMass - OxygenMass - CD2), 100R, "-CD2(Sn1)") With {
        .SpectrumComment = SpectrumComment.snposition
    }
}
            If Equals(adduct.AdductIonName, "[M+H]+") Then
                spectrum.AddRange({New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - chainMass - C3H8NO6P - HydrogenMass - OxygenMass - CD2), 100R, "-Header -CD2(Sn1)") With {
.SpectrumComment = SpectrumComment.snposition
}})
            End If
