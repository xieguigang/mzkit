...
Namespace CompMs.Common.Lipidomics
    ...
    .Charge = adduct.ChargeNumber
        ...
        Private Function GetLDGTSSpectrum(ByVal lipid As ILipid, ByVal adduct As AdductIon) As SpectrumPeak()
    ...
    New SpectrumPeak(adduct.ConvertToMz(C7H13NO2 - CH2 * 2 + HydrogenMass), 200R, "Header - C2H3") With {
        .SpectrumComment = SpectrumComment.metaboliteclass
    }, ' 117[M+H]+
    ...
    New SpectrumPeak(adduct.ConvertToMz(Gly_O), 50R, "Gly-O") With {
        ...
        Private Function GetAcylLevelSpectrum(ByVal lipid As ILipid, ByVal acylChain As IChain, ByVal adduct As AdductIon) As SpectrumPeak()
            ...
            Return {New SpectrumPeak(adduct.ConvertToMz(lipidMass - chainMass), 300R, $"-{acylChain}") With {
