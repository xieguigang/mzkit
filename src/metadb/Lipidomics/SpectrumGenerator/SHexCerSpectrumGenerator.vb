...
Public Class SHexCerSpectrumGenerator
    ...
    .Charge = adduct.ChargeNumber
        ...
        Private Function GetSHexCerSpectrum(ByVal lipid As ILipid, ByVal adduct As AdductIon) As SpectrumPeak()
            Dim spectrum = New List(Of SpectrumPeak) From {
    New SpectrumPeak(adduct.ConvertToMz(lipid.Mass), 999R, "Precursor") With {
        .SpectrumComment = SpectrumComment.precursor
    },
    New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - SO3 - H2O), 200R, "[M-H2SO4+H]+") With {
        .SpectrumComment = SpectrumComment.metaboliteclass,
        .IsAbsolutelyRequiredFragmentForAnnotation = True
    }
}
            If Equals(adduct.AdductIonName, "[M+H]+") Then
                spectrum.AddRange({New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - SO3), 100R, "[M-SO3+H]+") With {
.SpectrumComment = SpectrumComment.metaboliteclass
}, New SpectrumPeak(adduct.ConvertToMz(C8H16NO6), 150R, "[C8H16NO6+H]+") With {
.SpectrumComment = SpectrumComment.metaboliteclass,
.IsAbsolutelyRequiredFragmentForAnnotation = True
}, New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - SO3 - C6H10O5 - H2O * 2), 150R, "[M-C6H12O9S-H2O+H]+") With {
.SpectrumComment = SpectrumComment.metaboliteclass
}, New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - SO3 - C6H10O5 - H2O), 250R, "[M-C6H12O9S+H]+") With {
.SpectrumComment = SpectrumComment.metaboliteclass,
.IsAbsolutelyRequiredFragmentForAnnotation = True
}, New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - SO3 - C6H10O5), 100R, "[M-C6H10O8S+H]+") With {
.SpectrumComment = SpectrumComment.metaboliteclass
}, New SpectrumPeak(adduct.ConvertToMz(C8H16NO6 + SO3), 150R, "[C8H16NO9S+H]+") With {
.SpectrumComment = SpectrumComment.metaboliteclass
}})
            ElseIf Equals(adduct.AdductIonName, "[M+Na]+") Then
                spectrum.AddRange({New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - SO3), 700R, "[M-SO3+Na]+") With {
.SpectrumComment = SpectrumComment.metaboliteclass
}, New SpectrumPeak(adduct.ConvertToMz(C6H10O5 + H2O), 400R, "[Hex+Na]+") With {
.SpectrumComment = SpectrumComment.metaboliteclass
}, New SpectrumPeak(adduct.ConvertToMz(C8H16NO6), 500R, "[C8H16NO6+Na]+") With {
.SpectrumComment = SpectrumComment.metaboliteclass,
.IsAbsolutelyRequiredFragmentForAnnotation = True
}, New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - SO3 - C6H10O5 - H2O), 150R, "[M-C6H12O9S+Na]+") With {
.SpectrumComment = SpectrumComment.metaboliteclass,
.IsAbsolutelyRequiredFragmentForAnnotation = True
}, New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - SO3 - C6H10O5), 250R, "[M-C6H10O8S+Na]+") With {
.SpectrumComment = SpectrumComment.metaboliteclass
}, New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - SO3 - C6H10O5 + CarbonMass + OxygenMass), 200R, "[M-C5H10O7S+Na]+") With {
.SpectrumComment = SpectrumComment.metaboliteclass
}, New SpectrumPeak(adduct.ConvertToMz(C8H16NO6 + SO3), 100R, "[C8H16NO9S+Na]+") With {
.SpectrumComment = SpectrumComment.metaboliteclass
}})
            End If
...
'new SpectrumPeak(adduct.ConvertToMz(chainMass + C6H10O5 - MassDiffDictionary.NitrogenMass - MassDiffDictionary.HydrogenMass*2), 80d, "[sph+Hex+H]+") { SpectrumComment = SpectrumComment.acylchain },
        ...
        Private Function GetAcylSpectrum(ByVal lipid As ILipid, ByVal acyl As AcylChain, ByVal adduct As AdductIon) As SpectrumPeak()
            ...
            Dim spectrum = New List(Of SpectrumPeak)()
            If Equals(adduct.AdductIonName, "[M+H]+") Then
                spectrum.AddRange({New SpectrumPeak(adduct.ConvertToMz(chainMass + NitrogenMass + HydrogenMass), 150R, "[FAA+H]+") With {
.SpectrumComment = SpectrumComment.acylchain
}, New SpectrumPeak(adduct.ConvertToMz(chainMass + C2H2N), 200R, "[FA+C2H2N+H]+") With {
.SpectrumComment = SpectrumComment.acylchain
}})
            ElseIf Equals(adduct.AdductIonName, "[M+Na]+") Then
                spectrum.AddRange({New SpectrumPeak(adduct.ConvertToMz(chainMass + NitrogenMass + C6H10O5 + H2O + NitrogenMass + CarbonMass), 100R, "[FAA+C2H2+Hex+Na]+") With {
.SpectrumComment = SpectrumComment.acylchain
}, New SpectrumPeak(adduct.ConvertToMz(chainMass + NitrogenMass + HydrogenMass * 4), 100R, "[FAA+3H+Na]+") With {
.SpectrumComment = SpectrumComment.acylchain
}, New SpectrumPeak(adduct.ConvertToMz(chainMass + NitrogenMass + HydrogenMass * 4 + Na), 200R, "[FAA+3H+2Na]+") With {
.SpectrumComment = SpectrumComment.acylchain
}})
            End If
            Return spectrum.ToArray()
