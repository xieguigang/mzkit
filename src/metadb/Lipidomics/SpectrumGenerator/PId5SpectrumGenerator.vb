...
Public Class PId5SpectrumGenerator
    ...
    .Charge = adduct.ChargeNumber
        ...
        Private Function GetPISpectrum(ByVal lipid As ILipid, ByVal adduct As AdductIon) As SpectrumPeak()
...
'new SpectrumPeak(adduct.ConvertToMz(lipidMass - chainMass - C6H10O5), 100d, $"-C6H10O5 -{acylChain}") { SpectrumComment = SpectrumComment.acylchain },
        ...
        Private Function GetAcylPositionSpectrum(ByVal lipid As ILipid, ByVal acylChain As IChain, ByVal adduct As AdductIon) As SpectrumPeak()
            ...
            Return {New SpectrumPeak(lipidMass - chainMass - H2O + HydrogenMass - CD2, 50R, "-CD2(Sn1)") With {
