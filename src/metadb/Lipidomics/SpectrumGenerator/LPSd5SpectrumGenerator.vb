...
.SpectrumComment = SpectrumComment.metaboliteclass
}, New SpectrumPeak(adduct.ConvertToMz(C3H4D5O6P), 100R, "C3H4D5O6P") With {
.SpectrumComment = SpectrumComment.metaboliteclass
...
.SpectrumComment = SpectrumComment.acylchain
        ...
        Private Function GetAcylPositionSpectrum(lipid As ILipid, acylChain As IChain, adduct As AdductIon) As SpectrumPeak()
            Dim lipidMass = lipid.Mass
            Dim chainMass = acylChain.Mass - HydrogenMass
            Return {New SpectrumPeak(adduct.ConvertToMz(lipidMass - chainMass - H2O - CD2), 100R, "-CD2(Sn1)") With {
