...
Public Class LPGEidSpectrumGenerator
        ...
        Public Function Generate(lipid As Lipid, adduct As AdductIon, Optional molecule As IMoleculeProperty = Nothing) As IMSScanProperty Implements ILipidSpectrumGenerator.Generate
            ...
            If lipid.Description.Has(LipidDescription.Chain) Then
                ...
                spectrum.AddRange(EidSpecificSpectrum(lipid, adduct, nlMass, 150R))
            End If
...
'new SpectrumPeak(adduct.ConvertToMz(lipid.Mass - chainMass - H2O), 100d, $"-{acylChain}-H2O") { SpectrumComment = SpectrumComment.acylchain },
        ...
        Private Function GetAcylPositionSpectrum(lipid As ILipid, acylChain As IChain, adduct As AdductIon) As SpectrumPeak()
            ...
            Return {New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - chainMass - OxygenMass - CH2), 100R, "-CH2(Sn1)") With {
.SpectrumComment = SpectrumComment.snposition
}, New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - chainMass - H2O - HydrogenMass - OxygenMass - CH2), 100R, "-H2O -CH2(Sn1)") With {
.SpectrumComment = SpectrumComment.snposition
}}
        End Function
