...
.SpectrumComment = SpectrumComment.metaboliteclass
            ...
            If Equals(adduct.AdductIonName, "[M+Na]+") Then
                spectrum.AddRange({New SpectrumPeak(adduct.ConvertToMz(C3H9O6P), 300R, "Header") With {
.SpectrumComment = SpectrumComment.metaboliteclass,
.IsAbsolutelyRequiredFragmentForAnnotation = True
}, New SpectrumPeak(adduct.ConvertToMz(C3H9O6P - H2O), 200R, "Header - H2O") With {
.SpectrumComment = SpectrumComment.metaboliteclass,
.IsAbsolutelyRequiredFragmentForAnnotation = True
...
.SpectrumComment = SpectrumComment.precursor
            ...
            If Equals(adduct.AdductIonName, "[M+H]+") OrElse Equals(adduct.AdductIonName, "[M+NH4]+") Then
                spectrum.AddRange({New SpectrumPeak(lipidMass - C3H6O2, 100R, "Precursor -C3H6O2") With {
.SpectrumComment = SpectrumComment.metaboliteclass
}, New SpectrumPeak(lipidMass - H2O, 500R, "[M+H]+ -H2O") With {
.SpectrumComment = SpectrumComment.metaboliteclass
}, New SpectrumPeak(lipidMass - H2O * 2, 200R, "[M+H]+ -2H2O") With {
.SpectrumComment = SpectrumComment.metaboliteclass
}, New SpectrumPeak(lipidMass - C3H6O2 - H2O, 100R, "[M+H]+ -C3H6O2 -H2O") With {
.SpectrumComment = SpectrumComment.metaboliteclass
}, New SpectrumPeak(Gly_C + ProtonMass, 100R, "Gly-C") With {
.SpectrumComment = SpectrumComment.metaboliteclass
}, New SpectrumPeak(Gly_O + ProtonMass, 100R, "Gly-O") With {
.SpectrumComment = SpectrumComment.metaboliteclass
}, New SpectrumPeak(C3H9O6P + ProtonMass, 300R, "Header") With {
.SpectrumComment = SpectrumComment.metaboliteclass,
.IsAbsolutelyRequiredFragmentForAnnotation = True
}, New SpectrumPeak(C3H9O6P - H2O + ProtonMass, 200R, "Header - H2O") With {
.SpectrumComment = SpectrumComment.metaboliteclass,
.IsAbsolutelyRequiredFragmentForAnnotation = True
}, New SpectrumPeak(lipid.Mass - C3H9O6P + ProtonMass, 500R, "Precursor -C3H9O6P") With {
.SpectrumComment = SpectrumComment.metaboliteclass
}})
            End If
...
.SpectrumComment = SpectrumComment.acylchain
}, New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - chainMass - H2O), 100R, $"-{acylChain}-H2O") With {
.SpectrumComment = SpectrumComment.acylchain
}})
            End If
            Return spectrum.ToArray()
        ...
        Private Function GetAcylPositionSpectrum(lipid As ILipid, acylChain As IChain, adduct As AdductIon) As SpectrumPeak()
            ...
            Return {New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - chainMass - HydrogenMass - OxygenMass - CH2), 100R, "-CH2(Sn1)") With {
.SpectrumComment = SpectrumComment.snposition
}, New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - chainMass - HydrogenMass - OxygenMass - H2O - CH2), 100R, "-H2O -CH2(Sn1)") With {
.SpectrumComment = SpectrumComment.snposition
}}
        End Function
