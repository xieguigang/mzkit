    ...
    New SpectrumPeak(adduct.ConvertToMz(lipid.Mass), 999R, "Precursor") With {
        ...
        Private Function GetAcylLevelSpectrum(lipid As ILipid, acylChain As IChain, adduct As AdductIon) As SpectrumPeak()
            ...
            If Equals(adduct.AdductIonName, "[M+Na]+") Then
                spectrum.AddRange({New SpectrumPeak(chainMass2 + C2D3O + OxygenMass, 100R, $"{acylChain}+C2D3O2") With {
.SpectrumComment = SpectrumComment.acylchain
}, New SpectrumPeak(chainMass2 + C2D3O + CD2, 100R, $"{acylChain}+C3D5O") With {
.SpectrumComment = SpectrumComment.acylchain
...
.SpectrumComment = SpectrumComment.acylchain
}, New SpectrumPeak(chainMass2 + C3D5O2, 100R, $"{acylChain}+C3D5O2") With {
.SpectrumComment = SpectrumComment.acylchain
}, New SpectrumPeak(chainMass2 + C3D5O2 - OxygenMass, 100R, $"{acylChain}+C3D5O") With {
.SpectrumComment = SpectrumComment.acylchain
...
.SpectrumComment = SpectrumComment.acylchain
        ...
        Private Function GetAcylPositionSpectrum(lipid As ILipid, acylChain As IChain, adduct As AdductIon) As SpectrumPeak()
            ...
            Dim spectrum = New List(Of SpectrumPeak)()
            If Equals(adduct.AdductIonName, "[M+Na]+") Then
                spectrum.AddRange({New SpectrumPeak(chainMass + C2D3O, 100R, "Sn2 diagnostics") With {
...
'new SpectrumPeak(lipidMass - chainMass - MassDiffDictionary.OxygenMass , 200d, $"-{acylChain}-O Sn2") { SpectrumComment = SpectrumComment.acylchain },
            ...
            Else
                ...
                spectrum.AddRange({New SpectrumPeak(acylChain.Mass + Electron, 100R, $"{acylChain}+ Sn2") With {
            .SpectrumComment = SpectrumComment.acylchain
                }, New SpectrumPeak(chainMass + C3D5O2, 100R, $"{acylChain}+C3D5O2 Sn2") With {
            .SpectrumComment = SpectrumComment.acylchain
                }, New SpectrumPeak(chainMass + C3D5O2 - H2O, 100R, $"{acylChain}+C3D3O Sn2") With {
            .SpectrumComment = SpectrumComment.acylchain
