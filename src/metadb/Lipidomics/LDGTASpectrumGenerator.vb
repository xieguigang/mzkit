...
Namespace CompMs.Common.Lipidomics
    ...
    .Charge = adduct.ChargeNumber
        ...
        Private Function GetLDGTASpectrum(ByVal lipid As ILipid, ByVal adduct As AdductIon) As SpectrumPeak()
            Dim spectrum = New List(Of SpectrumPeak) From {
    New SpectrumPeak(adduct.ConvertToMz(lipid.Mass), 999R, "Precursor") With {
        .SpectrumComment = SpectrumComment.precursor
    },
    New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - CHO2), 100R, "Precursor - CO2") With {
        .SpectrumComment = SpectrumComment.metaboliteclass
    },
    New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - H2O), 50R, "Precursor - H2O") With {
        .SpectrumComment = SpectrumComment.metaboliteclass
    },
    New SpectrumPeak(adduct.ConvertToMz(C8H16NO3), 100R, "C8H16NO3") With {
        .SpectrumComment = SpectrumComment.metaboliteclass
    }, '175[M+H]+
    New SpectrumPeak(adduct.ConvertToMz(C7H13NO2), 100R, "Header") With {
        .SpectrumComment = SpectrumComment.metaboliteclass
    }, '144[M+H]+
    New SpectrumPeak(adduct.ConvertToMz(C7H13NO2 + H2O), 200R, "Header + H2O") With {
        .SpectrumComment = SpectrumComment.metaboliteclass
    }, '162[M+H]+
    New SpectrumPeak(adduct.ConvertToMz(C7H13NO2 + OxygenMass), 200R, "Header + O") With {
        .SpectrumComment = SpectrumComment.metaboliteclass
    }, '160[M+H]+
...
.SpectrumComment = SpectrumComment.acylchain
        ...
        Private Function GetAcylPositionSpectrum(ByVal lipid As ILipid, ByVal acylChain As IChain, ByVal adduct As AdductIon) As SpectrumPeak()
            ...
            Return {New SpectrumPeak(adduct.ConvertToMz(lipidMass - chainMass - H2O + HydrogenMass - CH2), 100R, "-CH2(Sn1)") With {
