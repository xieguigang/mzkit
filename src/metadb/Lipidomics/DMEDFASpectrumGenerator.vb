...
Namespace CompMs.Common.Lipidomics
    ...
    New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - C2NH7), 200R, "Precursor - C2NH7") With {
        .SpectrumComment = SpectrumComment.metaboliteclass
    }
}
            If lipid.Chains.OxidizedCount > 0 Then
                spectrum.Add(New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - C2NH7 - H2O), 50R, "Precursor - C2NH7 - H2O") With {
                    .SpectrumComment = SpectrumComment.metaboliteclass
                })
            End If
