...
Namespace CompMs.Common.Lipidomics
    ...
    .Charge = adduct.ChargeNumber
        ...
        Private Function GetCARSpectrum(ByVal lipid As ILipid, ByVal adduct As AdductIon) As SpectrumPeak()
            Dim spectrum = New List(Of SpectrumPeak) From {
    New SpectrumPeak(adduct.ConvertToMz(lipid.Mass), 999R, "Precursor") With {
        .SpectrumComment = SpectrumComment.precursor
    },
    New SpectrumPeak(adduct.ConvertToMz(lipid.Mass) - CHO2, 150R, "Precursor-CHO2") With {
        .SpectrumComment = SpectrumComment.metaboliteclass
    }, ' M-45
    New SpectrumPeak(adduct.ConvertToMz(C7H15NO3), 150R, "Header") With {
        .SpectrumComment = SpectrumComment.metaboliteclass,
        .IsAbsolutelyRequiredFragmentForAnnotation = True
    }, '172
    New SpectrumPeak(adduct.ConvertToMz(C7H15NO3 - H2O), 150R, "Header-H2O") With {
        .SpectrumComment = SpectrumComment.metaboliteclass,
        .IsAbsolutelyRequiredFragmentForAnnotation = True
    } '144
}
        ...
        Private Function GetAcylLevelSpectrum(ByVal lipid As ILipid, ByVal acylChain As AcylChain, ByVal adduct As AdductIon) As SpectrumPeak()
            ...
            Dim spectrum = New List(Of SpectrumPeak)()
            spectrum.AddRange({New SpectrumPeak(adduct.ConvertToMz(chainMass), 50R, $"[Acyl]+") With {
