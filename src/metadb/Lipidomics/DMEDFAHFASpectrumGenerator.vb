...
.IsAbsolutelyRequiredFragmentForAnnotation = True
        ...
        End Function
        Private Function GetOxPositionSpectrum(ByVal lipid As ILipid, ByVal acylChain As AcylChain, ByVal adduct As AdductIon) As SpectrumPeak()
            Dim adductmass = adduct.AdductIonAccurateMass
...
.IsAbsolutelyRequiredFragmentForAnnotation = True
            ...
            Return spectrum.ToArray()
        End Function
        Private Function GetDMEDFAHFASpectrum(ByVal lipid As ILipid, ByVal adduct As AdductIon) As SpectrumPeak()
