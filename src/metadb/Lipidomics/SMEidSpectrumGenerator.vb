...
Namespace CompMs.Common.Lipidomics
    ...
    New SpectrumPeak(adduct.ConvertToMz(C5H14NO4P + C2H3NO - OxygenMass), 150R, "C7H18N2O4P (Header+C2H3N)") With {
        .SpectrumComment = SpectrumComment.metaboliteclass,
        .IsAbsolutelyRequiredFragmentForAnnotation = True
    }
}
            If Equals(adduct.AdductIonName, "[M+Na]+") Then
                spectrum.AddRange({New SpectrumPeak(adduct.ConvertToMz(lipid.Mass) - C3H9N, 150R, "Precursor-C3H9N") With {
.SpectrumComment = SpectrumComment.metaboliteclass,
.IsAbsolutelyRequiredFragmentForAnnotation = True
...
.SpectrumComment = SpectrumComment.metaboliteclass
            ...
            ElseIf Equals(adduct.AdductIonName, "[M+H]+") Then
                spectrum.AddRange({New SpectrumPeak(adduct.ConvertToMz(C5H14NO4P + C2H3NO + CarbonMass), 150R, "C7H18N2O4P (Header+C3H3NO)") With {
.SpectrumComment = SpectrumComment.metaboliteclass
}}) ' need to consider
            End If
