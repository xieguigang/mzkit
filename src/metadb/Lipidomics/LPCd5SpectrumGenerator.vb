...
.SpectrumComment = SpectrumComment.metaboliteclass
            ...
            ElseIf Equals(adduct.AdductIonName, "[M+Na]+") Then
                spectrum.AddRange({New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - C3H9N), 800R, "Precursor -C3H9N") With {
.SpectrumComment = SpectrumComment.metaboliteclass
...
.SpectrumComment = SpectrumComment.acylchain
        ...
        Private Function GetAcylPositionSpectrum(ByVal lipid As ILipid, ByVal acylChain As IChain, ByVal adduct As AdductIon) As SpectrumPeak()
            Return {New SpectrumPeak(adduct.ConvertToMz(lipid.Mass - acylChain.Mass - OxygenMass - CD2 - HydrogenMass), 100R, "-CD2(Sn1)") With {
