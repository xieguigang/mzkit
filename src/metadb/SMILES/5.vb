...
Namespace com.Demo2
    Public Class VFMatch
        ...
        ''' @return
        ''' </><C>>  </><C>> ... </param></C></param>        Public Overridable Sub CandidateP(ByVal result As IDictionary(Of Integer?, List(Of ChemicalElement)), ByVal quG As ChemicalFormula, ByVal bgG As ChemicalFormula, ByVal Mqu As List(Of ChemicalElement), ByVal Mdb As List(Of ChemicalElement))
            Dim count = 0
