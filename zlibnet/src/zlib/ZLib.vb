...
Friend NotInheritable Class ZLib
    ...
    Private Shared Function deflateInit2_32(ByRef strm As z_stream, level As Integer, method As Integer, windowBits As Integer, memLevel As Integer, strategy As Integer,
    ...
    Private Shared Function deflateInit2_64(ByRef strm As z_stream, level As Integer, method As Integer, windowBits As Integer, memLevel As Integer, strategy As Integer,
        version As String, stream_size As Integer) As Integer
    End Function
    ...
    Friend Shared Function deflateInit(ByRef strm As z_stream, level As CompressionLevel, windowBits As ZLibWriteType) As Integer
        If ZLibDll.Is64 Then
            Return deflateInit2_64(strm, CInt(level), Z_DEFLATED, CInt(windowBits), DEF_MEM_LEVEL, Z_DEFAULT_STRATEGY,
                ZLibVersion, Marshal.SizeOf(GetType(z_stream)))
        Else
            Return deflateInit2_32(strm, CInt(level), Z_DEFLATED, CInt(windowBits), DEF_MEM_LEVEL, Z_DEFAULT_STRATEGY,
                ZLibVersion, Marshal.SizeOf(GetType(z_stream)))
        End If
    End Function
